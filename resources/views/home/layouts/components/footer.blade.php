<footer class="footer-section bg_img" data-background="{{ asset('assets/images/elements/footer.png') }}">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div class="subscribe-area">
            <div class="obj"><img src="{{ asset('assets/images/elements/subscribe.png') }}" alt="image"></div>
      ...
      <div class="row footer-bottom align-items-center">
        <div class="col-lg-7 col-md-6 text-md-left text-center">
          <p class="copy-right-text">Copyright © 2022. All Rights Reserved By <a href="#0">OPHELA</a></p>
        </div>
