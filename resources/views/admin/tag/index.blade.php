                        ...
                        <?php $no++ ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    @csrf @method('DELETE')
                                        <button type="button" class="btn btn-primary btn-round" data-toggle="modal" data-target="#editTag-{{ $item->slug }}">
                                            <i class="fas fa-pen"></i>
                                        </button>
                                        <button type="submit" class="btn btn-danger btn-round" onclick="return confirm('Apakah anda yakin ingin menghapus tag ini?')">
