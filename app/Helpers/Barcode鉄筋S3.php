...
if(!function_exists('Barcode鉄筋S3')) {
    function Barcode鉄筋S3($data)
    {
        ...
        <defs>
          <image id="Bitmap_1XX" x="0" y="0" width="200" height="100" xlink:href="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAMgAAABkCAYAAADDhn8LAAABG0lEQVR4nO3TsRHAIBDAsIf9
      ...
      M 279.5 -0.05
      L 0 -0.05 0 386.35 279.5 386.35 279.5 -0.05 Z" />
                </g>
              </g>
            </g>
            <g>
      ...
      L 5.6 300.4" />
            ...
            <g transform="matrix( 1, 0, 0, 1, 235.9,342.4) ">
