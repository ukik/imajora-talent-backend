...
if(!function_exists('Barcodeコンクリート1_OLD')) {
    function Barcodeコンクリート1_OLD($data)
    {
        ...
        <defs>
            <image id="barcode_mortar_svg_Layer_1__Image_" x="-7.5" y="0" width="100" height="30"
        ...
        L 245.5 -63.7" />
                ...
                <g transform="matrix( 2.35, 0, 0, 3.33331298828125, 31.25,-30) ">
